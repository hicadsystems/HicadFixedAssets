                    ...
                    <form>
                      <fieldset>
                        ...
                        <div class="form-group row">
                          <label for="rate" class="col-sm-4 col-form-label"
                            >Rate :</label
                          >
                          <div class="col-sm-4">
                            <input
    ...
    <nav v-if="!isFormVisible" aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item" aria-current="page">
          <a @click="showForm()"
            ><span class="btn btn-primary h5">Create Class</span></a
          >
        </li>
      </ol>
    </nav>
                ...
                <tr v-for="(AssetClass, index) in classList" :key="index">
                  ...
                  <td>
                    <button
                      type="button"
                      class="btn btn-submit btn-primary"
                      @click="editAssetClass(AssetClass.classcode)"
                    >
                      Edit
                    </button>
                    <button
    ...
    editAssetClass(classcode) {
      axios
        ...
        .then((response) => {
          ...
          this.objectBody.led_accum_depr_code =
            response.data.data.led_accum_depr_code;
      ...
      this.$confirm({
        ...
        callback: (confirm) => {
          if (confirm) {
            ...
            axios
              .get(`/api/AssetClass/removeclass/${classcode}`)
              .then((response) => {
                if (response.data.responseCode == "200") {
                  this.$alert(
                    classdesc + " Deleted Successfully!!!",
                    "Ok",
                    "success"
                  );
                }
