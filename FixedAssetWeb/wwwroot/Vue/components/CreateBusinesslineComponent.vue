        ...
        <div class="row">
          <div class="col-12 col-xl-4">
            <div class="form-group">
              ...
              <input
                ...
                name="Code"
                class="form-control"
                v-model="postBody.Code"
                required
                :readonly="submitorUpdate == 'Update'"
              />
            </div>
          </div>
          <div class="col-12 col-xl-4">
          ...
          <div class="col-12 col-xl-4">
            <div class="form-group">
              ...
              <input
                ...
                v-model="postBody.processingMonth"
                placeholder=""
              />
            </div>
          </div>
          <div class="col-12 col-xl-4">
            <div class="form-group">
              ...
              <input
                class="form-control"
                name="processingYear"
                v-model="postBody.processingYear"
                placeholder=""
              />
            </div>
          </div>
          <div class="col-12 col-xl-4">
            <div class="form-group">
              ...
              <select
                class="form-control"
                v-model="postBody.incomeacct"
                name="incomeacct"
                required
              >
                <option
                  v-for="liability in LiabilityList"
                  v-bind:value="liability.acctcode"
                  v-bind:key="liability.acctcode"
                >
          ...
          <div class="col-12 col-xl-4">
            <div class="form-group">
              ...
              <select
                class="form-control"
                v-model="postBody.interestacct"
                name="interestacct"
                required
              >
                <option
                  v-for="interest in InterestList"
                  v-bind:value="interest.acctcode"
                  v-bind:key="interest.acctcode"
                >
          ...
          <div class="col-12 col-xl-4">
            <div class="form-group">
              ...
              <select
                class="form-control"
                v-model="postBody.fundacct"
                name="fundacct"
                required
              >
                <option
                  v-for="Fund in FundacList"
                  v-bind:value="Fund.acctcode"
                  v-bind:key="Fund.acctcode"
                >
                  {{ Fund.description }}
                </option>
              </select>
          ...
          <div class="col-12 col-xl-4">
            <div class="form-group">
              ...
              <select
                class="form-control"
                v-model="postBody.trusteeacct"
                name="trusteeacct"
                required
              >
                <option
                  v-for="Trustee in TrusteeList"
                  v-bind:value="Trustee.acctcode"
                  v-bind:key="Trustee.acctcode"
                >
                  {{ Trustee.description }}
                </option>
              </select>
          ...
          <div class="col-12">
            <div
              class="btn-group mr-2 sw-btn-group-extra"
              v-if="canProcess"
              role="group"
            >
              <button
    ...
    "$store.state.objectToUpdate": function (newVal, oldVal) {
      (this.postBody.Code = this.$store.state.objectToUpdate.code),
        ...
        (this.postBody.processingMonth =
          this.$store.state.objectToUpdate.processingMonth),
        (this.postBody.processingYear =
          this.$store.state.objectToUpdate.processingYear),
        (this.postBody.fundacct = this.$store.state.objectToUpdate.fundacct),
        (this.postBody.incomeacct =
          this.$store.state.objectToUpdate.incomeacct),
        (this.postBody.interestacct =
          this.$store.state.objectToUpdate.interestacct),
        (this.postBody.trusteeacct =
          this.$store.state.objectToUpdate.trusteeacct);
  ...
  methods: {
    ...
    postPost() {
      if (this.submitorUpdate == "Submit") {
        axios
          .post(`/api/BusinessLine/createBusinessLine`, this.postBody)
          .then((response) => {
      ...
      if (this.submitorUpdate == "Update") {
        axios
          .put(`/api/BusinessLine/updateBusinessLine`, this.postBody)
          .then((response) => {
            this.responseMessage = response.data.responseDescription;
            this.canProcess = true;
            if (response.data.responseCode == "200") {
