            ...
            <table id="datatables-buttons" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    <tr v-for="(costCenter,index) in costCenterList" :key="index">
                        ...
                        <td>
                            <button type="button" class="btn btn-submit btn-primary" @click="processRetrieve(costCenter)">Edit</button>
                            <button type="button" class="btn btn-submit btn-primary" @click="processDelete(costCenter.id)">Delete</button></td>
                    </tr>
                </tbody>
     ...
     methods: {
        ...
        processRetrieve : function (costCenter) {
         ...
         processDelete: function (id) {
             ...
             axios.get(`/api/CostCenter/RemoveCostCenter/${id}`)
                 .then(response => {
